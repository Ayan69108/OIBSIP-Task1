...
class BankAccount {
    ...
    void deposit(int amount) {
        if (amount != 0) {
            ...
            System.out.println("Amount present currently:"+balance);
        }
    }
            ...
            do {
                ...
                switch (option) {
                    ...
                    case 'E':
                        ...
                        BankAccount bb = new BankAccount("Ayan", "2002");
...
public class ATMinterface {
    public static void main(String[] args) {
        BankAccount ba = new BankAccount("SYED AYAN AHMED", "2002");
        ba.checkId();
    }
